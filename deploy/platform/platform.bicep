...
@description('The name of the api app service resource. For example: myapi will deploy an app service available at https://myapi.azurewebsites.net')
param name string
    ...
    siteConfig: {
      ...
      cors: {
        allowedOrigins: [
          ...
          'https://${name_clean_short}.azurewebsites.net'
        ]
